...
public static class Planet 
{
    ...
    private static GameObject m_PlanetMesh;
    public static List<Polygon> m_Polygons;
    public static List<Vector3> m_Vertices;
    ...
    public static void InitAsIcosohedron()
    {
    ...
    public static void Subdivide(int recursions)
    {
    ...
    public static Mesh GenerateMesh(int divideCount)
    {
        InitAsIcosohedron();
        Subdivide(divideCount);
        ...
        //m_PlanetMesh.gameObject.AddComponent<SphereVerts>();
        //MeshRenderer surfaceRenderer = FindObjectOfType<SphereVerts>().gameObject.GetComponent<MeshRenderer>();
          
        //surfaceRenderer.material = (Material)AssetDatabase.LoadAssetAtPath("Assets/Scripts/SphereMat.mat", typeof(Material));
        ...
        //Moja pêtla od przemieszczania wierzcho³ków.
        //float factor = this.gameObject.GetComponent<SphereGen>().factor;
        //float factor2 = this.gameObject.GetComponent<SphereGen>().factor2;
        /*
        for (int i = 0; i < vertices.Length; i++)
        {
            //Debug.Log(vertices[i].y + " AND : " + Mathf.Sin(this.gameObject.GetComponent<SphereGen>().SineWaveSec * vertices[i].y));
            //vertices[i].y += Mathf.Abs(Mathf.Sin(factor * vertices[i].y) * factor2);
            vertices[i].y -= vertices[i].y * factor;
        ...
        */
        ...
        //MeshFilter terrainFilter = (MeshFilter)FindObjectOfType<SphereVerts>().gameObject.GetComponent<MeshFilter>();
